...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/Scheds.css">
...
<body>
    <section>
        <img src="image/rare.png">
        <div class="content">
            <h3><span>Cainta Catholic College</span></h3>
            <p>A. Bonifacio Avenue</p>
            <p>Poblacion Cainta Rizal 1900</p>
        </div>
    </section>
    <div class="container">
        <h5 class="main">PROFESSOR SCHEDULE</h5>
        <?php
        if (isset($selectedProfessor)) {
            echo '<h5 class="main">S. Y. ' . htmlspecialchars($activeSchoolYear) . '</h5>';
            echo '<h5 style="float: left; margin-right: 20px;">Professor: ' . htmlspecialchars($selectedProfessor) . '</h5>';
            echo '<h5 style="clear: both; float: left;">Semester: ' . htmlspecialchars($activeSemester) . '</h5>';
